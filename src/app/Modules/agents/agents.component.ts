...
export class AgentsComponent {
  ...
  agentId = '681372e5066cb2590fb6a0be';
  interval: any;
  ...
  startSendingLocations() {
    this.interval = setInterval(() => {
      ...
      this.locationService.sendAgentLocation(this.agentId, [lng, lat]);
      console.log(this.agentId,[lng,lat]);
  ...
  ngOnInit(): void {
    ...
    this.locationService.registerAgent(this.agentId);
