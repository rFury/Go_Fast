...
@Component({
    ...
    standalone     : true,
    imports        : [FormsModule, ReactiveFormsModule, MatRadioModule, MatIconModule, MatFormFieldModule, MatInputModule, MatSelectModule, MatOptionModule, MatButtonModule],
})
